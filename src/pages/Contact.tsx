    ...
    <div className="min-h-screen bg-gradient-to-b from-light-bg to-white dark:from-neutral-950 dark:to-neutral-900 pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-neutral-500 text-sm sm:text-base leading-relaxed dark:text-neutral-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="space-y-4">
            {contactInfo.map((info) => (
              <div key={info.label} className="bg-white border border-neutral-200/60 shadow-sm p-5 rounded-2xl flex items-center gap-4 dark:bg-neutral-900 dark:border-neutral-800">
                ...
                <div>
                  <p className="text-[10px] text-neutral-400 font-display uppercase tracking-widest dark:text-neutral-500">{info.label}</p>
