        ...
        <div className="bg-white/90 dark:bg-neutral-900/90 backdrop-blur-md border border-neutral-200/60 dark:border-neutral-700/60 shadow-sm p-8 rounded-xl">
          ...
          <div className="mt-5 pt-4 border-t border-neutral-100 dark:border-neutral-700">
            ...
            <div className="flex gap-3">
              <button type="button" onClick={() => { setLoading(true); setTimeout(() => { login('google@apexride.com'); navigate('/'); setLoading(false); }, 800); }}
              ...
              <button type="button" onClick={() => { setLoading(true); setTimeout(() => { login('facebook@apexride.com'); navigate('/'); setLoading(false); }, 800); }}
                className="flex-1 flex items-center justify-center gap-2 py-2.5 border border-neutral-200 dark:border-neutral-700 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors cursor-pointer">
